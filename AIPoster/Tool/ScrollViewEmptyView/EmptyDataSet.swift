...
//                view.addGestureRecognizer(tapGesture)
                view.addTarget(self, action: #selector(didTapContentView(_:)), for: UIControl.Event.touchUpInside)
    ...
    @objc private func didTapContentView(_ sender: EmptyDataSetView) {
