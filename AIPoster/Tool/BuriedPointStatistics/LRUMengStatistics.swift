//
//  LRUMengStatistics.swift
//  HSTranslation
//
//  Created by 苍蓝猛兽 on 2022/10/10.
//

import UIKit

class LRUMengStatistics: NSObject {
    
    public static let shared = LRUMengStatistics()
    override init() {
        super.init()
        UMengConfigure()
    }
    
    private let UMengKey: String = "6401557ad64e6861393cb465"
    private let UMengChannel: String = "App Store"
    
    private func UMengConfigure() {
        UMConfigure.initWithAppkey(UMengKey, channel: UMengChannel)
    }
